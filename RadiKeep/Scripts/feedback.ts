...
let globalToastTimerId: number | undefined;

/**
 * 全画面共通のトースト表示
 */
export function showGlobalToast(message: string, isSuccess = true): void {
    let toast = document.getElementById('global-result-toast') as HTMLDivElement | null;
    let messageElm = document.getElementById('global-result-toast-message') as HTMLSpanElement | null;
    let closeButton = document.getElementById('global-result-toast-close') as HTMLButtonElement | null;
    ...
    if (!toast) {
        ...
        messageElm = document.getElementById('global-result-toast-message') as HTMLSpanElement | null;
        closeButton = document.getElementById('global-result-toast-close') as HTMLButtonElement | null;
    }
