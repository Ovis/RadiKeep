...
export function formatJumpLabel(seconds) {
    if (seconds >= 60) {
        return `${Math.floor(seconds / 60)}分`;
    }
    return `${seconds}秒`;
}
export function seekAudio(audioElm, deltaSeconds) {
...
export function createStandardPlayerJumpControls(audioElm, options = {}) {
