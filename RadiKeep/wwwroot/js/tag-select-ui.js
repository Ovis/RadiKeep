export function clearMultiSelect(selectElm) {
    Array.from(selectElm.options).forEach((option) => {
        option.selected = false;
    });
}
export function enableTouchLikeMultiSelect(selectElm) {
...
export function renderSelectedTagChips(selectElm, container, options = {}) {
...
//# sourceMappingURL=tag-select-ui.js.map